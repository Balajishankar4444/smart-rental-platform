      ...
      <main className="mx-auto max-w-7xl px-6 pt-28 pb-32 lg:px-12 space-y-10">
        ...
        <div className="bg-white rounded-3xl p-6 lg:p-8 border border-gray-100 shadow-xl shadow-gray-200/40 space-y-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
            {[
              { name: "Email Verified", status: "Verified", desc: "alex.schmidt@rentit.de" },
              { name: "Phone Verified", status: "Verified", desc: "+49 151 9876543" },
              { name: "Address Verified", status: "Verified", desc: "Stuttgart, Germany" },
              { name: "Government ID", status: "Verified", desc: "Passport Checked" },
              { name: "Bank Account", status: "Verified", desc: "IBAN Connected" },
            ].map((v, i) => (
