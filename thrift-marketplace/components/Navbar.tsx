...
export const Navbar = () => {
  ...
  const listingPath = "http://localhost:3000/listings/1";
  const settingPath = "http://localhost:3000/setting";
      ...
      >
        <div className="mx-auto flex max-w-[1440px] items-center justify-between px-6 lg:px-12">
          ...
          <div className="flex items-center gap-4">
            ...
            {/* Start Renting Button (Always Visible when not loading) */}
            {!isLoading && (
              <RippleButton
