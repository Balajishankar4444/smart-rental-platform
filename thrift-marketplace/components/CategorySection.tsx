      ...
      >
        <div className="mx-auto flex max-w-[1440px] items-center justify-between px-6 lg:px-12">
          ...
          <div className="flex items-center gap-4">
            ...
            <RippleButton 
              onClick={() => window.location.href = "/list-item"}
              className="hidden sm:inline-flex gap-2 rounded-[18px] bg-gradient-to-r from-[#2563EB] to-[#4F46E5] px-5 py-2.5 text-sm font-semibold text-white shadow-lg shadow-blue-500/25"
            >
          ...
          >
            ...
            <div className="flex flex-col gap-3 border-t border-gray-100 pt-6">
              <Link
                href="/login"
                onClick={() => setMobileMenuOpen(false)}
                className="w-full py-3.5 rounded-2xl border border-gray-200 text-sm font-bold text-gray-800 text-center"
              >
                Log In
              </Link>
              <RippleButton 
                ...
                className="w-full py-3.5 rounded-2xl bg-[#2563EB] text-sm font-bold text-white shadow-lg shadow-blue-500/25"
              >
                Start Earning
              </RippleButton>
            </div>
